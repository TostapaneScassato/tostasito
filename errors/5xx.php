...
<head>
    <meta charset="UTF-8">
    <title><?php echo htmlspecialchars($code) ?> - <?php echo htmlspecialchars($text) ?></title>
...
<body>
    <mark>
        ...
        <h1 class="title"><?php echo htmlspecialchars($code) ?> - <?php echo htmlspecialchars($text) ?></h1>
        <i class="material-icons" id="title">warning</i>
    </mark>
